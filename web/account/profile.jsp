...
<div class="group-contajner">
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-8">
                <div class="column">
                    <table id="main-discountType-table" class="ui celled selectable right aligned table">
                        <thead>
                        <th class="center aligned">Aktuálne zľavy</th>
                        </thead>
                        <tbody>
                        <c:forEach items="${discountsType}" var="discountType">
                <tr data-id="${discountType.idTypu}">
                    <td class="center aligned">${discountType.nazovTypu}</td>
                </tr>
                </c:forEach>
                        </tbody>
                    </table>
            ...
            <div class="col-md-4">
                <div class="container-button m-b-20">
                    <button id="new-main-discount-type" class="ui labeled inverted green icon button  zelenac">
                        <div class="middle">
                            <i class="fa fa-plus"></i>
                            Pridaj
                        </div>
                    </button>
                    <button id="delete-main-discout-type" class="ui labeled inverted red icon button cervenak">
                        <div class="middle">
                            <i class="fa fa-minus"></i>
                            Odstráň
                        </div>
                    </button>
                    <button id="edit-main-discount-type" class="ui labeled inverted blue icon button belasa">
                        <div class="middle">
                            <i class="fa fa-pencil"></i>
                            Edituj
                        </div>
...
<div id="delete-discounts-type-modal" class="ui basic modal customModal">
    ...
    <div class="content">
        <p>Naozaj chcete odstrániť vybraný typ zľavy?</p>
    </div>
    <div class="actions">
        <div class="ui red basic cancel inverted button">
            <i class="fa fa-sign-out"></i>
...
<div id="discounts-type-modal" class="ui mini modal customModal">
    <div class="header">
        Discount type
    </div>
    <div class="ui form content">
        <div class="one field">
            <div class="field required">
                <label>Názov</label>
                <input type="text" name="discount-type-name" placeholder="Názov typu zľavy"
                       value="">
            </div>
        </div>
    </div>
    ...
    <input hidden type="text" name="discounts-type-id" value="">
</div>
</body>
</html>
</jsp:attribute>
